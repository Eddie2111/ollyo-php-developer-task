...
<body>
    <div class="max-w-[1200px] mx-auto my-20">
        ...
        <div class="min-w-[480px] bg-white shadow rounded-md p-4 flex flex-col items-center gap-4 text-center">
            <h1 class="text-2xl text-red-600 font-bold">Payment Failed</h1>
            <p class="text-gray-500">We are sorry to let you know that your payment didn't reach us.</p>

            <!-- Display Error Message -->
            <?php if (!empty($error)) : ?>
                <div class="bg-red-100 border border-red-300 text-red-700 px-4 py-2 rounded-md w-full text-sm">
                    <strong>Error:</strong> <?php echo htmlspecialchars($error); ?>
                </div>
            <?php endif; ?>

            <a href="/checkout" class="hover:underline hover:underline-offset-4 hover:text-green-700">Go back to checkout page</a>
        </div>
    </div>
</body>
</html>