...
<body>
    <div class="max-w-[1200px] mx-auto my-20">
        ...
        <div class="min-w-[480px] bg-white shadow rounded-md p-4 flex flex-col items-center gap-4">
            <h1 class="text-2xl text-gray-700 font-bold">Your payment was successful!</h1>
            <p class="text-gray-500">We ensure to serve you the best of our services, thank you for staying with us.</p>
            <a href="/" class="hover:underline hover:underline-offset-4 hover:text-green-700">Go to Home Page</a>
        </div>
    </div>
</body>
</html>